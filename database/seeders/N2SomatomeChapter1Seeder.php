...
class N2SomatomeChapter1Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($kanjiItems as $kanjiData) {
            $kanjiSlug = 'n2-somatome-ch1-kanji-'.Str::slug($kanjiData['meaning'].'-'.$kanjiData['onyomi'], '-');
    ...
    {
        $batches = require database_path('seeders/data/n2_somatome_ch1_pending.php');
