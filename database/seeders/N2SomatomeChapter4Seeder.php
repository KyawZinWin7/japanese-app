...
class N2SomatomeChapter4Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($kanjiItems as $kanjiData) {
            $kanjiSlug = 'n2-somatome-ch4-kanji-'.Str::slug(($kanjiData['meaning'] ?? '').'-'.($kanjiData['onyomi'] ?? $kanjiData['character']), '-');
    ...
    {
        $path = database_path('seeders/data/n2_somatome_ch4_pending.php');
