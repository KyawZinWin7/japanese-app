...
class N2SomatomeChapter3Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($kanjiItems as $kanjiData) {
            $kanjiSlug = 'n2-somatome-ch3-kanji-'.Str::slug(($kanjiData['meaning'] ?? '').'-'.($kanjiData['onyomi'] ?? $kanjiData['character']), '-');
    ...
    {
        $path = database_path('seeders/data/n2_somatome_ch3_pending.php');
