...
class N2SomatomeChapter8Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($kanjiItems as $kanjiData) {
            $kanjiSlug = 'n2-somatome-ch8-kanji-'.Str::slug($kanjiData['meaning'].'-'.$kanjiData['onyomi'], '-');
    ...
    {
        $path = database_path('seeders/data/n2_somatome_ch8_pending.php');
