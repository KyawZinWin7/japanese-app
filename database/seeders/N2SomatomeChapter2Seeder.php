...
class N2SomatomeChapter2Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($kanjiItems as $kanjiData) {
            $kanjiSlug = 'n2-somatome-ch2-kanji-'.Str::slug($kanjiData['meaning'].'-'.$kanjiData['onyomi'], '-');
            ...
            Kanji::updateOrCreate(
                ...
                [
                    ...
                    'example_translation_mm' => $kanjiData['example_translation_mm'],
    ...
    {
        $batches = require database_path('seeders/data/n2_somatome_ch2_pending.php');
